...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    public static void timeCalculations(String currentDirectory, String file, String set, RedBlackBST bst) throws FileNotFoundException {
        String st;
        long k = 0;
        Long number;
        ...
        writeData( currentDirectory + "/Times/RBT/" + set + "-" +file, String.valueOf(insertTime)+","+ String.valueOf(searchTime)+","+ String.valueOf(deleteTime));
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File file2 = new File(currentDirectory + "/Times/RBT");
